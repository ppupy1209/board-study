...
![Modu Square 홈 화면](docs/images/modu-square-home.png)

## 주요 기능

### 새로운 이야기

홈에서는 새 글과 지금 인기 있는 이야기를 함께 볼 수 있습니다. 게시글 카드에서 바로 좋아요를 누르거나 나중에 읽을 글로 저장할 수 있습니다. 좋아요, 댓글, 조회수는 목록과 상세 화면에 같은 값으로 표시됩니다.
